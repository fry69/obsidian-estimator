/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8388ca03801f811a9a228f0b39ac5544)
...
declare namespace Cloudflare {
	...
	interface Env {
		QUEUE_DATA: KVNamespace;
		GITHUB_APP_KV: KVNamespace;
		TRIGGER_TOKEN: string;
		PUBLIC_BASE_URL: string;
		GH_APP_ID: string;
		GH_INSTALLATION_ID: string;
		GH_APP_KEY_PASSWORD: string;
	}
}
